...
public class Main extends javax.swing.JFrame {
    ...
    public Main() throws SQLException {
        initComponents();        
        URL path_violao = this.getClass().getClassLoader().getResource("violao.png");
...
//            button.setText("---");
//        }
        Connection connection = ConexaoSQLite.get();
            ...
            if (nome != null) {
                if (!nome.isEmpty()) {
                    ...
                    if (rs.next()) {
                        ...
                        for (Entry<Integer, JButton> entry : this.violao.entrySet()) {
